...
public class King 
{
    public ArrayList<Point> moves(Piece piece, Piece[][] board, Point indexes)
    {
        ...
        else
        {
            ...
            //short castle
            if(indexes.x == 4 && piece.amountMoved == 0 && board[indexes.x + 1][indexes.y].piece == null && board[indexes.x + 2][indexes.y].piece == null && board[board[0].length - 1][0].piece != null && board[board[0].length - 1][0].pieceType.equalsIgnoreCase("r") && board[board[0].length - 1][0].amountMoved == 0 && board[board[0].length - 1][0].color.equalsIgnoreCase("b"))
            {
                moves.add(new Point(indexes.x + 2, indexes.y));
            }

            //long castle
            if(indexes.x == 4 && piece.amountMoved == 0 && board[indexes.x - 1][indexes.y].piece == null && board[indexes.x - 2][indexes.y].piece == null && board[indexes.x - 3][indexes.y].piece == null && board[0][0].piece != null && board[0][0].pieceType.equalsIgnoreCase("r") && board[0][0].amountMoved == 0 && board[0][0].color.equalsIgnoreCase("b"))
            {
                moves.add(new Point(indexes.x - 2, indexes.y));
            }
        }
